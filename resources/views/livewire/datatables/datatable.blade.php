<div>
    ...
    <div class="relative">
        ...
        @if($hideable === 'buttons')
        <div class="p-2 grid grid-cols-8 gap-2" id="mobile" >
            @foreach($this->columns as $index => $column)
            <div id="respon">
            <button style="width: 100%;" wire:click.prefetch="toggle('{{ $index }}')" class="cubutton px-3 py-2 rounded text-white text-xs focus:outline-none
