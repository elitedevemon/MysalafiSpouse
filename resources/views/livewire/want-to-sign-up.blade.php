<section id="main" id="content" class="full-width">
    <div id="post-3275" class="post-3275 page type-page status-publish hentry">
        <span class="entry-title rich-snippet-hidden">I WANT TO SIGN UP!</span><span
            class="vcard rich-snippet-hidden"><span class="fn"><a href="https://mysalafispouse.com/author/devsite/"
                    title="Posts by H" rel="author">H</a></span></span><span
                        ...
                        <div class="fusion-column-wrapper fusion-flex-justify-content-flex-start fusion-content-layout-column"
                            ...
                            <div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-one fusion-border-below-title"
                                ...
                                <h1 class="title-heading-center fusion-responsive-typography-calculated"
                                    ...
                                    data-fontsize="35" data-lineheight="39.2px">I WANT TO SIGN UP!</h1>
                            </div>
                        </div>
                    </div>
                    <style type="text/css">
                        ...
                        <div class="fusion-column-wrapper fusion-flex-justify-content-center fusion-content-layout-column"
                            ...
                            <div class="fusion-title title fusion-title-2 fusion-sep-none fusion-title-text fusion-title-size-one fusion-border-below-title"
                                ...
                                <h1 class="title-heading-left fusion-responsive-typography-calculated"
                                    style="font-family: Poppins; font-weight: 500; margin: 0px; font-size: 1em; color: rgb(48, 48, 48); --fontSize:30; line-height: 1.12;"
                                    data-fontsize="30" data-lineheight="33.6px">
                                    <p style="text-align: center;">PLEASE MENTION THE FOLLOWING INFO TO HELP US FIND
                                        YOUR SPOUSE<br>
                                        جزاكم الله خيرا</p>
                                </h1>
                            </div>
                            ...
                            <div class="fusion-text fusion-text-1">
                                ...
                                <div class="happyforms-form happyforms-styles happyforms-form--hide-title happyforms-form--submit-button-border-radius-pill happyforms-form--submit-button-fullwidth"
                                    ...
                                    <h3 class="happyforms-form__title fusion-responsive-typography-calculated"
                                        ...
                                        style="--fontSize:32; line-height: 1.26;">I want to sign up</h3>
                                    <div class="happyforms-flex">
                                            ...
                                            <div class="happyforms-part-wrap">
                                                <div class="happyforms-part__label-container">
                                                    <label for="happyforms-3443_email_7" class="happyforms-part__label">
                                                        <span class="label">Your Email Adress/Gmail?</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="happyforms-part__el">
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input value="Male" type="radio"
                                                                class="happyforms-visuallyhidden" wire:model="gender"
                                                                value="0">
                                                            <span class="checkmark"><span
                                                                    class="happyforms-radio-circle"></span></span>
                                                            <span class="label">I am a Brother (Male)</span>
                                                        </label>
                                                    ...
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            ...
                                                            <span class="checkmark"><span
                                                                    class="happyforms-radio-circle"></span></span>
                                                            <span class="label">I am a Sister (Female)</span>
                                                        </label>
                                                        <span class="happyforms-part-option__description"></span>
                                                    </div>
                                                    <div class="happyforms-part-error-notice"
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--single_line_text happyforms-part--width-full happyforms-part--label-above"
                                            id="happyforms-3443_single_line_text_1-part"
                                            data-happyforms-type="single_line_text"
                                            data-happyforms-id="single_line_text_1" data-happyforms-required="">
                                            <div class="happyforms-part-wrap">
                                                <div class="happyforms-part__label-container">
                                                    <label for="happyforms-3443_single_line_text_1"
                                                        class="happyforms-part__label">
                                                        <span class="label">Your Ethnicity &amp; Residence?</span>
                                                    </label>
                                                </div>
                                                <div class="happyforms-part__el">
                                                    <div class="happyforms-input">
                                                        <input id="happyforms-3443_single_line_text_1" type="text"
                                                            wire:model="ethnicity_residence"
                                                            placeholder="This field is required">
                                                    </div>
                                                    <div class="happyforms-part-error-notice"
                                                        id="happyforms-error-3443_email_7">
                                                        @error('ethnicity_residence')
                                                        <p>This field is required</p>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--single_line_text happyforms-part--width-full happyforms-part--label-above"
                                            id="happyforms-3443_single_line_text_2-part"
                                            data-happyforms-type="single_line_text"
                                            data-happyforms-id="single_line_text_2" data-happyforms-required="">
                                            <div class="happyforms-part-wrap">
                                                <div class="happyforms-part__label-container">
                                                    <label for="happyforms-3443_single_line_text_2"
                                                        class="happyforms-part__label">
                                                        <span class="label">Your Age &amp; Height?</span>
                                                    </label>
                                                </div>
                                                <div class="happyforms-part__el">
                                                    <div class="happyforms-input">
                                                        <input id="happyforms-3443_single_line_text_2" type="text"
                                                            wire:model="age_height"
                                                            placeholder="This field is required">
                                                    </div>
                                                    <div class="happyforms-part-error-notice"
                                                        id="happyforms-error-3443_email_7">
                                            ...
                                            <div class="happyforms-part-wrap">
                                                <div class="happyforms-part__label-container">
                                                    <label for="happyforms-3443_multi_line_text_3"
                                                        class="happyforms-part__label">
                                                        <span class="label">A Brief Background About
                                                            Yourself?</span>
                                                    </label>
                                                </div>
                                                <div class="happyforms-part__el">
                                                    <textarea id="happyforms-3443_multi_line_text_3"
                                                        wire:model="background" rows="5"
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--multi_line_text happyforms-part--width-full happyforms-part--label-above"
                                            id="happyforms-3443_multi_line_text_4-part"
                                            data-happyforms-type="multi_line_text"
                                            data-happyforms-id="multi_line_text_4" data-happyforms-required="">
                                            <div class="happyforms-part-wrap">
                                                <div class="happyforms-part__label-container">
                                                    <label for="happyforms-3443_multi_line_text_4"
                                                        class="happyforms-part__label">
                                                        <span class="label">What Are You Looking For In A Potential
                                                            Spouse?</span>
                                                    </label>
                                                </div>
                                                <div class="happyforms-part__el">
                                                    <textarea id="happyforms-3443_multi_line_text_4"
                                                        wire:model="potential" rows="5"
                                                        placeholder="This field is required"></textarea>
                                                    <div class="happyforms-part-error-notice"
                                                        id="happyforms-error-3443_email_7">
                                                        @error('potential')
                                            ...
                                            <div class="happyforms-part-wrap">
                                                <div class="happyforms-part__label-container">
                                                    <label for="happyforms-3443_checkbox_9"
                                                        class="happyforms-part__label">
                                                        <span class="label">What Ulema (Scholars) Do You Listen
                                                            To?</span>
                                                    </label>
                                                </div>
                                                <div class="happyforms-part__el">
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input type="checkbox" value="Shaykh al-Albani"
                                                    ...
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input wire:model="scholar.1" type="checkbox"
                                                                class="happyforms-visuallyhidden happyforms-checkbox"
                                                    ...
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input wire:model="scholar.2" type="checkbox"
                                                                class="happyforms-visuallyhidden happyforms-checkbox"
                                                    ...
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input wire:model="scholar.3" type="checkbox"
                                                                class="happyforms-visuallyhidden happyforms-checkbox"
                                                    ...
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input wire:model="scholar.6" type="checkbox"
                                                                class="happyforms-visuallyhidden happyforms-checkbox"
                                                    ...
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input wire:model="scholar.4" type="checkbox"
                                                                class="happyforms-visuallyhidden happyforms-checkbox"
                                                    ...
                                                    <div class="happyforms-part__option happyforms-part-option"
                                                        ...
                                                        <label class="option-label">
                                                            <input wire:model="scholar.5" type="checkbox"
                                                                class="happyforms-visuallyhidden happyforms-checkbox"
                                                    ...
                                                    <div class="" id="checkbox_9_other">
                                                        ...
                                                        @if($chk)
                                                        <input type="text" wire:model="other_scholar"
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--single_line_text happyforms-part--width-full happyforms-part--label-above"
                                            id="happyforms-3443_single_line_text_8-part"
                                            data-happyforms-type="single_line_text"
                                            data-happyforms-id="single_line_text_8" data-happyforms-required="">
                                            <div class="happyforms-part-wrap">

                                                <div class="happyforms-part__label-container">
                                                    <label for="happyforms-3443_single_line_text_8"
                                                        class="happyforms-part__label">
                                                        <span class="label">Have You Been Married Before?</span>
                                                    </label>
                                                </div>
                                                <div class="happyforms-part__el">
                                                    <div class="happyforms-input">
                                                        <input id="happyforms-3443_single_line_text_8" type="text"
                                                            wire:model="before_married"
                                                            placeholder="This field is required">
                                                    </div>
                                                    <div class="happyforms-part-error-notice"
                                                        id="happyforms-error-3443_email_7">
                                                        @error('before_married')
                                                        <p>This field is required</p>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                            ...
                                            <button wire:click="store" wire:loading.attr='disabled' wire:target='store'
                                                style="padding: 15px 30px;1px solid transparent;ont-size: var(--happyforms-submit-button-font-size);color:white;background:black;width:100%;border-radius: 47px;"
                                                type="submit"
                                                class="happyforms-submit happyforms-button--submit devsite">SUBMIT MY
                                                PROFILE!</button>
                                            <div style="text-align:center;" wire:loading wire:target="store">
                                                Loading
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @endif
                                @if($msg)
                                <div class="happyforms-flex" wire:ignore>
                                    <div class="happyforms-message-notices"
                                        style="background: #d4f3d4;padding:10px;color:green;border-radius: 10px;">
                                        {{-- <div class="happyforms-message-notice success">
                                            <h2 data-fontsize="16" data-lineheight="18.24px"
                                                class="fusion-responsive-typography-calculated"
                                                style="--fontSize:16; line-height: 1.14; --minFontSize:16;"> --}}
                                        <p>Your profile has been sent to the MySalafiSpouse team! We will email
                                            you shortly with the next steps.</p>
                                        {{-- </h2> --}}
                                    </div>
                                </div>
                                <label>
                                    <input type="checkbox" name="3443single_line_text_-1" value="1"
                                        style="display: none;" tabindex="-1" autocomplete="off"> <span
                                        class="screen-reader-text">Spam protection, skip this field</span>
                                </label>
                                <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                </div>
                            </div>
