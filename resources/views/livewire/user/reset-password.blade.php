<section id="content" class="full-width">
    <div id="post-3275" class="post-3275 page type-page status-publish hentry">
        <span class="entry-title rich-snippet-hidden">Reset Password!</span><span class="vcard rich-snippet-hidden"><span
                            ...
                            <div class="fusion-text fusion-text-1">
                                ...
                                <div class="happyforms-form happyforms-styles happyforms-form--hide-title happyforms-form--submit-button-border-radius-pill happyforms-form--submit-button-fullwidth"
                                    ...
                                    <h3 class="happyforms-form__title fusion-responsive-typography-calculated"
                                        ...
                                        style="--fontSize:32; line-height: 1.26;">Reset Password</h3>
                                    <div class="happyforms-flex">
                                        @error('credentials')
                                        <div style="text-align: center;width:100%;background:#ffc4c4;color:red;padding:10px;border-radius:10px;">
                                            {{ $message }}
                                        </div>
                                        @enderror
                                        <div class="happyforms-part--with-autocomplete happyforms-form__part happyforms-part happyforms-part--email happyforms-part--width-full happyforms-part--label-above"
                                            ...
                                            <a href="{{ url('/login') }}"> <span style="text-align: center;">Login</span></a>
                                        </div>
                                        
                                  

                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                            <button wire:click="sednEmail" wire:loading.attr='disabled' wire:target='sednEmail'
                                                ...
                                                type="submit"
                                                class="happyforms-submit happyforms-button--submit devsite">Send Email
                                                <span  wire:loading wire:target="sednEmail">
                                                    Loading...
                                                </span>
                                            </button>
