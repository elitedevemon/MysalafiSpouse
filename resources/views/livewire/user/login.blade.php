                        ...
                        <div class="fusion-column-wrapper fusion-flex-justify-content-flex-start fusion-content-layout-column"
                            ...
                            <div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-one fusion-border-below-title"
                                ...
                                <h1 class="title-heading-center fusion-responsive-typography-calculated"
                                    ...
                                    data-fontsize="35" data-lineheight="39.2px">MySalafiSpouse Portal Login</h1>
                            </div>
                        </div>
                    </div>
                    <style type="text/css">
                                    ...
                                    <div class="happyforms-flex">
                                        ...
                                        <div class="happyforms-part--with-autocomplete happyforms-form__part happyforms-part happyforms-part--email happyforms-part--width-full happyforms-part--label-above"
                                            ...
                                            <div class="happyforms-part-wrap">
                                                <div class="happyforms-part__label-container text-center">
                                                    <label for="happyforms-3443_email_7" class="happyforms-part__label">
                                                        <span class="label" style="font-size: 18px; font-weight:bold">Email/Profile Code:</span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="happyforms-part-wrap">
                                            <div class="happyforms-part__label-container text-center">
                                                <label for="happyforms-3443_email_7" class="happyforms-part__label">
                                                    <span class="label" style="font-size: 18px; font-weight:bold">Password:</span>
                                                </label>
                                            </div>
                                            <div class="happyforms-part__el">
                                        ...
                                        <div class="text-center">
                                          <a href="{{ url('/forgot-password') }}"> <span style="text-align: center;">Forgot Your Password?</span></a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                            <button wire:click="login"
                                                ...
                                                type="submit"
                                                class="happyforms-submit happyforms-button--submit devsite">Login
                                            </button>
                                        </div>
                                    </div>
                                </div>
