                        ...
                        <div class="fusion-column-wrapper fusion-flex-justify-content-flex-start fusion-content-layout-column"
                            ...
                            <div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-one fusion-border-below-title"
                                ...
                                <h1 class="title-heading-center fusion-responsive-typography-calculated"
                                    ...
                                    data-fontsize="35" data-lineheight="39.2px">My Profile</h1>
                                {{-- <p style="color: white;font-size:11px;">Available Balance ({{ $balanceTotal }})</p>
                                --}}
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="happyforms-form happyforms-styles happyforms-form--hide-title happyforms-form--submit-button-border-radius-pill happyforms-form--submit-button-fullwidth"
                                    ...
                                    <div class="happyforms-flex">
                                        ...
                                        <div class="col-md-12" style="padding-left:4px;">
                                            <b>Location</b> <span>{{ $user->residence }}</span>
                                        </div>
                                        <div class="col-md-12" style="padding-left:4px;">
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                            <a href="{{ url('/profile-edit') }}"
                                                style="text-align:center;border-color: #224794;padding: 15px 30px;1px solid transparent;ont-size: var(--happyforms-submit-button-font-size);color:white;background:#224794;width:100%;border-radius: 47px;"
                                                type="submit"
                                                class="happyforms-submit happyforms-button--submit devsite">Edit My Profile
                                            </a>
                                        </div>

                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                            <a href="{{ url('/dashboard?filter=sent') }}"
                                                style="text-align:center;border-color: green;padding: 15px 30px;1px solid transparent;ont-size: var(--happyforms-submit-button-font-size);color:white;background:green;width:100%;border-radius: 47px;"
                                                type="submit"
                                                class="happyforms-submit happyforms-button--submit devsite">Sent Match Requests
                                            </a>
                                        </div>
                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                            <a href="{{ url('/dashboard?filter=received') }}"
                                                style="text-align:center;border-color: pink;padding: 15px 30px;1px solid transparent;ont-size: var(--happyforms-submit-button-font-size);color:white;background:pink;width:100%;border-radius: 47px;"
                                                type="submit"
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                            <a href="{{ url('/dashboard?filter=Unsuccessfull') }}"
                                                style="text-align:center;border-color: green;padding: 15px 30px;1px solid transparent;ont-size: var(--happyforms-submit-button-font-size);color:white;background:#dd1922;width:100%;border-radius: 47px;"
                                                type="submit"
                                                class="happyforms-submit happyforms-button--submit devsite">
