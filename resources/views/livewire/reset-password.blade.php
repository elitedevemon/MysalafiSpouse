                        ...
                        <div class="card disable-rounded-right mb-0 p-2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input disabled wire:model="email" type="text" class="form-control" id="email"
                                        placeholder="email">
                                    @error('email')
                                ...
                                <div class="form-group mb-2">
                                    <label class="text-bold-600" for="otp">OTP</label>
                                    <input wire:model="otp" type="text" class="form-control" id="otp" placeholder="Otp">
                                    @error('otp')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <button wire:loading.attr='disabled' wire:target='resetPassword' type="button"
                                    wire:click.prevent="resetPassword" class="btn btn-primary glow w-100 position-relative">
                                    Verify
